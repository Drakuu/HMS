...
const EditPatientTest = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      patient_Detail: {  // Nest patient fields under patient_Detail
      ...
      selectedTests: testRows.map(row => ({
        test: row.testId,
        testDetails: {  // Include testDetails structure
      ...
      performedBy: "" // Add actual user if available
    };
    ...
    try {
      ...
      alert(`Error updating patient test: ${err.message}`);
    }
  };
  return (
