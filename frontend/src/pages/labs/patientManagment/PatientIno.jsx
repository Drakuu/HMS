...
const PatientInfoForm = ({
  ...
  console.log("thepatientpatient:  ", patient)
  return (
        ...
        {mode === "existing" ? (
          <>
            ...
            <InputField
              ...
              onChange={handlePatientChange}
            />
          {/* {console.log("the Guardian Name: ", patient)} */}
            <InputField
              name="Guardian"
              label="Guardian Name"
              placeholder="Enter full name"
            ...
            <div>
              ...
              <select
                id="MaritalStatus"
                name="maritalStatus" // match field name
            ...
            <div>
              ...
              <select
                id="ReferredBy"
                name="referredBy" // match field name
