    ...
    return reports.reduce(
      (acc, report) => {
        return {
          ...
          totalDiscount: acc.totalDiscount + (report.discount || 0),
          totalPaid: acc.totalPaid + (report.advancePayment || 0),
          totalBalance:
            acc.totalBalance +
            ((report.totalAmount || 0) - (report.advancePayment || 0)),
        };
      },
                ...
                {reports.map((report, index) => {
                  ...
                  return (
                    <tr key={index} className="border-b hover:bg-gray-50">
                      ...
                      <td className="p-2 border border-gray-200 text-right">
                        {formatCurrency(report.advancePayment)}
                      </td>
                      <td className="p-2 border border-gray-200 text-right">
