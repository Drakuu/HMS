      ...
      <form className="w-full p-6" onSubmit={handleSubmit}>
        ...
        <div className="mb-8">
          ...
          <span className="text-xs place-content-center flex text-gray-600">
            Img size must be less than 1mb <span className="text-red-400">*</span>
          </span>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { label: "Email Address", name: "doctor_Email", icon: faEnvelope, placeholder: "Enter Doctor Email", type: "email", onchange: handleEmailChange, error: emailError },
                ...
                <div className="relative">
                  ...
                  {field.type === "select" ? (
                    ...
                    <input
                      ...
                      className={`block w-full pl-10 pr-3 py-2 border ${field.error ? "border-red-500" : "border-gray-300"} rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500`}
                      required
                      maxLength={field.maxLength}
                    />
                  )}

                  {field.name === "doctor_Email" && emailError && (
