          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-700">
                ...
                {formatCurrency(currentReport.paidAmount)}
              </p>
              <p className="text-gray-700">
                <span className="font-medium text-teal-600">Final Amount:</span>{" "}
                {formatCurrency(currentReport.finalAmount)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-teal-50 p-8 text-right border-t border-gray-200">
          <div className="flex justify-between items-center">
            <div className="text-left">
              ...
              <p className="text-gray-600 text-sm">
                Last Updated:{" "}
                {formatDate(currentReport.updatedAt)}
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-600 text-sm">
                {currentReport.performedBy?.name ? 'Radiology Technician' : 'Consultant Radiologist'}
              </p>
            </div>
          </div>
        </div>
