    ...
    <html>
      ...
      <body>
        ...
        <div className="patient-info">
          <div className="info-item"><span className="label">MR#:</span> {formData.mrNumber || 'N/A'}</div>
          <div className="info-item"><span className="label">Name:</span> {formData.patientName || 'N/A'}</div>
          <div className="info-item"><span className="label">Doctor:</span> {formData.doctor || 'N/A'}</div>
