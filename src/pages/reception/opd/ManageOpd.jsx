              ...
              {filteredPatients.length > 0 ? (
                filteredPatients.map((patient) => (
                  <tr key={patient._id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">{patient.patient_ContactNo || 'N/A'}</div>
                      <div className="text-sm text-gray-500 truncate max-w-xs">
                        {patient.patient_Address?.substring(0, 20) || 'No address'}...
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">
                        {patient.patient_Guardian?.guardian_Name || 'N/A'}
                      </div>
...
// import Knife from "../../../assets/images/patient.png";
...
//       <button
//         className={`trigger-btn ${isAnimating ? "deleting" : ""}`}
//         onClick={handleClick}
...
//     // Calculate button position for precise targeting
...
//                         width: '70px', 
//                         height: '70px',
//                         // Set initial position based on button location
//                         top: `${buttonPos.top}px`,
//                         left: `${buttonPos.left + buttonPos.width}px`
//                     }} 
//                 />
//             )}
//         </div>
