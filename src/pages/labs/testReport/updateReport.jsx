...
console.log("The da t was osi :", patientTestById)
    ...
    const handleChange = (e, index, testId) => {
        ...
        if (name.startsWith("results.")) {
            ...
            const updatedResults = [...formData.results[testId]];
            updatedResults[index][subField] = value;
    ...
    const addResultField = (testId) => {
        setFormData((prev) => ({
            ...
            results: {
                ...
                [testId]: [
                    ...prev.results[testId],
                    { fieldName: "", value: "", notes: "", unit: "", normalRange: null },
                ],
            },
        }));
    };
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <button className="flex items-center px-4 py-2 bg-white text-gray-700 rounded-lg hover:bg-gray-50 transition-all duration-200 shadow-md">
                                    ...
                                    {selectedTests.map((test, index) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-full text-left p-3 rounded-lg transition-all duration-200 ${activeTestIndex === index
                                            ...
                                            >
                                                <div className="flex justify-between items-center">
                                                    ...
                                                    <span
                                                        className={`px-2 py-1 rounded-full text-xs ${activeTestIndex === index
                            ...
                            <div className="bg-white rounded-xl p-6 shadow-md">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <span
                                            className={`px-2 py-1 rounded-full text-xs font-medium ${patientData.paymentStatus === "paid"
                                                    ...
                                                    <div className="md:col-span-2">
                                                        ...
                                                        <div className="relative">
                                                            <input
                                                                ...
                                                                className={`w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 ${isNormal === true
