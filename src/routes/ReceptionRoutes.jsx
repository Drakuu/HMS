...
const ReceptionRoutes = () => {
  return (
    <>
      ...
      <Route path="/prescription-management" element={<ReceptionLayout>      <PrescriptionManagement />    </ReceptionLayout>} />

      <Route path="/stock-management" element={<ReceptionLayout>      <StockManagement />    </ReceptionLayout>} />
